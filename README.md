...
### 🎉 Version 2.6.0 - 23 Janvier 2026

#### 🤖 Outils IA Locaux + Améliorations Tests

**Ollama & Open WebUI Installés** :

- ✅ **Ollama** - Moteur IA local avec modèles open-source
- ✅ **Llama 3.2** (2 GB) - Modèle généraliste (~60% GPT-4)
- ✅ **Qwen 2.5 Coder** (4.7 GB) - Modèle spécialisé code (~70-75% Claude)
- ✅ **Open WebUI** - Interface type ChatGPT sur port 8080
- ✅ **100% gratuit et local** - Aucune donnée envoyée en ligne
- ✅ **GPU NVIDIA** - Accélération matérielle détectée

**Suite de Tests Améliorée** :

- ✅ **Bouton rapport global** - Affiche statistiques complètes après exécution
- ✅ **Rapport détaillé** - Résumé par section (P1/P2/P3), durées, recommandations
- ✅ **36 tests Vitest** - Tests unitaires Vue.js (ProductCard, AdminStats, AppHeader, etc.)
- ✅ **Test-suite.html** - Interface améliorée avec modal de rapport

**Configuration Développement** :

- Port **3000** (Express) : Backend API + pages HTML statiques
- Port **5173** (Vite) : Frontend Vue.js
- Port **8080** (Open WebUI) : Interface IA locale
- Port **11434** (Ollama) : Serveur IA

**Modèles IA Disponibles** :

```bash
ollama list
# llama3.2:latest - Généraliste (2 GB)
# qwen2.5-coder:7b - Code spécialisé (4.7 GB)
# qwen-coder-fixed - Version avec system prompt optimisé
```
